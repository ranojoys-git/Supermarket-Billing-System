...
public class Billing
{
    ...
    {          
        ...
        while(choice.equalsIgnoreCase("Y"))
        {
            ...
            try
            {
                //int id=Integer.parseInt(read1.readLine());// stores the id of the product to be purchased
                ...
                switch(id)
                {
                    ...
                    case 10011:
                    {
                        ...
                        String str=ScannerInput.askString(" Do U wish to Purchase ?  : YES/NO   ");//stores the confirmation of purchasing a product
        ...
        if(count!=0)
        {
            ...
            System.out.println("\t"+"______________________________________________________");
            double s=0.0;//stores the price of each product sold
    ...
    public static void menuDisplay()
    {
        ...
        System.out.println("\t"+"______________________________________________________");
    }//end of the menuDisplay function..
